...
if __name__ == '__main__':
    ...
    parser.add_argument('--glr', help='Generative network learning rate', default=1e-4, type=float)
    parser.add_argument('--popsize', help='Population size generated by the generative network', default=20,type=int)
    parser.add_argument('--nmag', help='Magnitude (support) of the generators input noise', default=2, type=float)
    parser.add_argument('--nannealing', help='Annealing factor for the input noise', default=0.99, type=float)
    parser.add_argument('--objective', help='Objective function to minimize', default='Rastrigin', type=str)
    parser.add_argument('--seed', help='Random seed for reproducibiltiy', default=1, type=int)
    parser.add_argument('--stopcriter', help='Stop criterion for the search', default=1e-8, type=float)
